...
PyBank: Financial Data Analysis
    ...
    Using multiple for loops, I then completed the following analysis on the data provided: 
...
PyPoll: Election Data Analysis 
    ...
    Using a for loop, I completed then following analysis on the data provided: 
